...
## Results
<p>The model that was trained using the George Method much better in the evaluation than the model which was trained with no particular sampling.<br>
...
<p><br>However the model which was trained with group balanced sampling performed well across all types of images.</p>
